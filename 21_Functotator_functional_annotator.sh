...
mkdir results/variants_somatic/annotation_funcotator
...
do
   ...
   gatk Funcotator \
     --variant ~/Documents/TFM/OC_TFM/results/variants_somatic/"SAMPLE".filtered_pon.vcf \
     --reference ~/Documents/TFM/data/reference/hg19.fasta \
     --ref-version hg19 \
     --data-sources-path ~/Documents/TFM/OC_TFM/test_somatic/funcotator_dataSources.v1.7.20200521s \
     --output ~/Documents/TFM/OC_TFM/results/variants_somatic/annotation_funcotator/"SAMPLE".funcotated.vcf \
