...
mkdir alignment #Crea un nuevo directorio llamado "alignment" en el directorio principal del proyecto. Este directorio se utilizará para almacenar los archivos de salida del alineamiento.
...
do
   ...
   bwa mem -t 8 data/reference/hg19.fasta \ # se utiliza bwa con opcion mem para la alineacion, con -t se especifica el número de hilos para paralelizar el proceso y se especifica el archivo de la referencia previamente indexada
