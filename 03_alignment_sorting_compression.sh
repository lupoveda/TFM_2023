...
do
   ...
   bwa mem -t 8 data/reference/hg19.fasta \
   data/fastq/fastp_results_1/"$SAMPLE"_R1.fastq.gz \
   data/fastq/fastp_results_1/"$SAMPLE"_R2.fastq.gz \
   | samtools sort \
   | samtools view -bh > alignment_all/"$SAMPLE".bam
done
